<template>
  <div>
      ...
      <div class="flex fl ml4-l ml2">
        <PrevNext :prev="prev" nome="blogNDI-slug" />
        <PrevNext :next="next" nome="blogNDI-slug" />
      </div>
      <div class="flex tc pa2">
        <NuxtLink class="f2-l f3 link grow br3 ba bw1 pa2 bg-animate hover-bg-light-purple bg-black-60 white" :to="{ name: 'ndi' }">NDI</NuxtLink>
      </div>
